# -*- coding: utf-8 -*-
# Generated by Django 1.10.4 on 2017-11-11 21:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('feature_class', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='fields', to='cloudSync.FeatureClass')),
            ],
            options={
                'ordering': ('name',),
            },
        ...
        migrations.AddField(
            ...
            name='gdb',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='datasets', to='cloudSync.GDB'),
        ),
        migrations.AddField(
            model_name='featureclass',
            name='feature_dataset',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='feature_classes', to='cloudSync.FeatureDataset'),
        ),
    ]
